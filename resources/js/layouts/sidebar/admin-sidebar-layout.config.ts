...
const config: SidebarLayoutConfig = {
    ...
    sidebarItems: [
        { label: 'Dashboard', route: '/admin/dashboard', icon: Home },
        {
            ...
            icon: FileText,
            children: [
                { label: 'Blog Posts', route: '/admin/blog-post', icon: FileText },
                { label: 'Contact Messages', route: '/admin/contact-message', icon: Mail },
            ],
        },
        {
            ...
            icon: Users,
            children: [
                { label: 'Quote Requests', route: '/admin/quote-request', icon: MessageSquare },
                { label: 'Testimonials', route: '/admin/testimonial', icon: Star },
        ...
        },
        {
            ...
            icon: ShoppingBag,
            children: [
                { label: 'Categories', route: '/admin/category', icon: Tag },
                { label: 'Products', route: '/admin/product', icon: Package },
            ],
        },
    ],
    profileMenu: {
