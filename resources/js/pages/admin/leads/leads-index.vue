...
import { Construction, UserCheck } from 'lucide-vue-next';
</script>
    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col items-center justify-center py-20">
        <div class="text-center">
          ...
          <p class="mt-2 max-w-md text-sm text-gray-600">This page is being developed. Lead management features will be available soon.</p>
        </div>
      </div>
    </div>
  </sidebar-layout>
