...
<template>
    <form @submit.prevent="submitForm">
        <div class="mb-8 grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div>
                <label for="venue_name" class="mb-2 block text-sm font-medium">Venue Name</label>
                <input
                    id="venue_name"
        ...
        <div class="mb-8">
            <label for="venue_address" class="mb-2 block text-sm font-medium">Venue Address</label>
            <input
                id="venue_address"
        ...
        <div class="mb-8">
            <label for="event_description" class="mb-2 block text-sm font-medium">Event Description *</label>
            <textarea
        ...
        <div class="mb-8">
            <label for="special_requests" class="mb-2 block text-sm font-medium">Special Requests</label>
            <textarea
                id="special_requests"
