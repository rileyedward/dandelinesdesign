        ...
        <div class="w-full md:w-2/3">
            <div class="space-y-4">
                <p>
                    ...
                    true passion for textiles and every kind of art medium imaginable. As long as I can remember. I have wanted to own my own business
                    to create shoppable displays with a combo of art and a curated selection of things I love.
                </p>
                <p>
                    ...
                    on any design project you are planning whether it be an upcoming event, or that floral design, or that perfect piece that
                    completes a room. Please reach out, lets meet and get creative!
                </p>
            </div>
        </div>
    </div>
